...
--
-- Table structure for table `FineStatus_Violator`
--

CREATE TABLE IF NOT EXISTS `FineStatus_Violator` (
...
--
-- Dumping data for table `FineStatus_Violator`
--

INSERT INTO `FineStatus_Violator` (`id`, `name`, `email`, `violence`, `fine`, `paid`, `due`, `address`, `city`, `state`, `country`, `contactno`, `registereddate`) VALUES
