...
--
-- Table structure for table `FineStatus_Inspector`
--

CREATE TABLE IF NOT EXISTS `FineStatus_Inspector` (
...
--
-- Dumping data for table `FineStatus_Inspector`
--

INSERT INTO `FineStatus_Inspector` (`id`, `name`, `password`, `email`, `contactno`) VALUES
