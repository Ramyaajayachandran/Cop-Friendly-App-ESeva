...
public class AddViolator extends JFrame {
	static AddViolator frame;
	...
	public AddViolator() {
		...
		JLabel lblAddInspector = new JLabel("Add Violator");
		...
		JLabel lblviolence = new JLabel("Cause:");
		...
		JButton btnAddInspector = new JButton("Add violator");
		btnAddInspector.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int status=ViolatorDao.save(s);
				
				if(status>0){
					JOptionPane.showMessageDialog(AddViolator.this,"Violator added successfully!");
					...
					JOptionPane.showMessageDialog(AddViolator.this,"Sorry, Unable to add Violator!");
				}
			}
		});
