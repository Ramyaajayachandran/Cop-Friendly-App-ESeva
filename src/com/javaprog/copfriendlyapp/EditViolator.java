...
public class EditViolator extends JFrame {
	static EditViolator frame;
	...
	public EditViolator() {
		...
		JLabel lblviolence = new JLabel("violence:");
		...
		JButton btnAddInspector = new JButton("Update Violator");
		btnAddInspector.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String name=textField.getText();
				String email=textField_1.getText();
				String violence=textField_2.getText();
				int fine=Integer.parseInt(textField_3.getText());
				...
				Violator s=new Violator(id,name,email,violence,fine,paid,due,address,city,state,country,contactno);
				int status=ViolatorDao.update(s);
				status=1;
				if(status>0){
					JOptionPane.showMessageDialog(EditViolator.this,"Violator updated successfully!");
					InspectorSection.main(new String[]{});
					frame.dispose();
				}else{
					JOptionPane.showMessageDialog(EditViolator.this,"Sorry, Unable to add Violator!");
				}
			}
		});
		...
		btnLoadRecord.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(sid==null||sid.trim().equals("")){
					JOptionPane.showMessageDialog(EditViolator.this,"Please enter id first!");
				}else{
				int id=Integer.parseInt(sid);
				Violator s=ViolatorDao.getViolatorByid(id);
				textField.setText(s.getName());
				textField_1.setText(s.getEmail());
				textField_2.setText(s.getviolence());
				textField_3.setText(String.valueOf(s.getfine()));
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(lblviolence, GroupLayout.PREFERRED_SIZE, 48, GroupLayout.PREFERRED_SIZE)
						.addComponent(lblfine, GroupLayout.PREFERRED_SIZE, 31, GroupLayout.PREFERRED_SIZE)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					.addGap(128)
					.addComponent(btnAddInspector, GroupLayout.PREFERRED_SIZE, 145, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGap(7)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addComponent(btnAddInspector, GroupLayout.PREFERRED_SIZE, 38, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnBack))
					.addContainerGap())
		);
